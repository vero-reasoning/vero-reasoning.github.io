...
sources = ["cap1.html", "cap2.html", "cap3.html"]
items = []
...
(base / "cap123.html").write_text(html, encoding="utf-8")
print("Wrote static cap123.html with inline DEMOS from cap1/2/3")
