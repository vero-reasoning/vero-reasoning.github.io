...
sources = ["chart1.html", "chart2.html", "chart3.html"]
items = []
...
(base / "chart123.html").write_text(html, encoding="utf-8")
print("Wrote static chart123.html with inline DEMOS from chart1/2/3")
