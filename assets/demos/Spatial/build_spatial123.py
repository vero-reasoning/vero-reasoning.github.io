...
sources = ["spatial1.html", "spatial2.html", "spatial3.html"]
items = []
...
<head>
    ...
    <title>Spatial & Actions Demos</title>
    <style>
        :root {{
            --bg: #f5f6fa;
            --card: #ffffff;
        ...
        <section class="chat-card" aria-label="Example conversation">
            ...
            <div class="chat-body">
                <article class="user-turn" aria-label="User message with image and question">
                    ...
                    <img class="problem-image" id="problemImage" src="" alt="Spatial problem screenshot" />
                </article>
...
(base / "spatial123.html").write_text(html, encoding="utf-8")
print("Wrote static spatial123.html with inline DEMOS from spatial1/2/3")
